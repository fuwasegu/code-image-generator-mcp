...
server.tool(
  ...
  "Generates a beautiful PNG image of source code with syntax highlighting, similar to Carbon (carbon.now.sh). Returns the image as base64 and saves it to the specified path.",
  {
    ...
    language: z
      .string()
      .describe('Language identifier for syntax highlighting (e.g., "typescript", "python", "rust")'),
    theme: z
      .string()
      .optional()
      .describe('Shiki theme name (default: "github-dark"). Examples: "github-light", "dracula", "one-dark-pro", "nord"'),
    fontFamily: z
      .string()
      .optional()
      .describe("Font family for rendering (default: JetBrains Mono with fallbacks)"),
    fontSize: z
      .number()
      .optional()
    ...
    imageWidth: z
      .number()
      .optional()
      .describe("Image width in pixels. Auto-calculated from content if omitted"),
    outputPath: z
      .string()
